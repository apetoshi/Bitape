...
"[project]/node_modules/@wagmi/core/dist/esm/transports/fallback.js [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function fallback(transports, config) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$viem$2f$_esm$2f$clients$2f$transports$2f$fallback$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["fallback"])(transports, config);
} //# sourceMappingURL=fallback.js.map
}}),
"[project]/node_modules/@wagmi/core/dist/esm/transports/connector.js [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function unstable_connector(connector, config = {}) {
    ...
    return (parameters)=>{
        ...
        const request = async ({ method, params })=>{
            ...
            if (!connector) throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$viem$2f$_esm$2f$errors$2f$rpc$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ProviderDisconnectedError"](new Error(`Could not find connector of type "${type}" in \`connectors\` passed to \`createConfig\`.`));
            const provider = await connector.getProvider({
                chainId: chain?.id
            });
            if (!provider) throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$viem$2f$_esm$2f$errors$2f$rpc$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ProviderDisconnectedError"](new Error('Provider is disconnected.'));
            ...
            const chainId = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$viem$2f$_esm$2f$utils$2f$encoding$2f$fromHex$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["hexToNumber"])(await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$viem$2f$_esm$2f$utils$2f$promise$2f$withRetry$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["withRetry"])(()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$viem$2f$_esm$2f$utils$2f$promise$2f$withTimeout$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["withTimeout"])(()=>provider.request({
                        method: 'eth_chainId'
                    }), {
                    timeout: 100
                })));
            if (chain && chainId !== chain.id) throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$viem$2f$_esm$2f$errors$2f$rpc$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ChainDisconnectedError"](new Error(`The current chain of the connector (id: ${chainId}) does not match the target chain for the request (id: ${chain.id} – ${chain.name}).`));
            const body = {
                method,
                params
            };
...
"[project]/node_modules/@wagmi/core/dist/esm/utils/normalizeChainId.js [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
//# sourceMappingURL=node_modules_%40wagmi_core_dist_esm_cd98bc1a._.js.map